    ...
    const animate = () => {
      ...
      for (let x = 0; x < canvas.width; x += 60) {
        for (let y = 0; y < canvas.height; y += 60) {
          ...
          const hue = 80 + Math.sin(time + distance * 0.01) * 15;
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {projects.map((proj) => (
              <a
                ...
                className="bg-white p-6 rounded-xl border border-gray-200 hover:border-lime-300 hover:shadow-lg transition"
              >
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={i} className="bg-white p-6 rounded-lg border border-gray-200 cursor-pointer">
                <summary className="font-bold text-gray-900 hover:text-lime-400">
                  {faq.q}
                </summary>
